-- ==============================================================================
-- SCRIPT DE IMPLANTACAO (DEPLOY)
-- INSTRUCOES: Execute este script no console do BigQuery para implantar a versao
--              homologada na tabela de producao apos validar em staging.
-- ==============================================================================

CREATE OR REPLACE VIEW `iron-rex-461220-g4.customer_intelligence.growth_engine_vendas_detalhado` AS
-- O codigo da view segue abaixo integralmente conforme a versao de Producao:
