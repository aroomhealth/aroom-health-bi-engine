-- ==============================================================================
-- VIEW STAGING: growth_engine_vendas_detalhado_staging
-- DATASET: customer_intelligence (ou database_aroom_health_dev)
-- DESCRICAO: Camada de staging para testar alteracoes de regras de negocio
--            antes da promocao para a view de producao principal.
-- ==============================================================================
